...
#import "Masonry.h"
#import "FHXTools.h"
@implementation FHXPercentLineMaskCell{
    
    FHXPercentLineMaskView * maskLineView;
...
- (void)awakeFromNib {
    ...
    maskLineView = [[FHXPercentLineMaskView alloc]initWithFrame:CGRectMake(0, 0, SCREEN_WIDTH - 30, 379)];
...
-(void)clickTopTypeAction:(NSInteger)tag{
    ...
    if ([self.delegate respondsToSelector:@selector(switchSelectTypeAction:)]) {
        [self.delegate switchSelectTypeAction:2];
    }
}
